...
class OidcSession
{
  private static $name = "SvgtaOidcLib";
  ...
  private function encrypt(string $str): string{
    ...
    return OidcJWT::encrypt($str, self::$encAlg, self::$encEnc, OidcSession::$encKey);
  }

  private function decrypt(string $jwe): ?string{
    return OidcJWT::decrypt($jwe, null, OidcSession::$encKey);
  }
